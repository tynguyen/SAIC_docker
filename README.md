...
- [x] [updated Jan 23rd 2023] Added ubuntun20.04 with python3.10
- [x] [updated June 2st 2021] move away .bashrc, .tmux.conf, my_docker_env.sh from the host machine by giving them directly
- [x] [updated June 1st 2021] more flexible on cudnn version and cuda version. New build_img.sh script enables to select cuda version as well as cudnn version.
...
- installation_scripts : contain all scripts, each of which installs a specific package.
  - install\_<pkg_name1>.sh
  - install\_<pkg_name2>.sh
  - ...
...
### Base image: tynguyen/ubuntu20.04:base-cuda11.3-cudnn8

Based on nvidia/cuda:11.3-cudnn8-devel-ubuntu20.04
...
### Dev image: tynguyen/ubuntu20.04:dev-cuda11.3-cudnn8

Based on tynguyen/ubuntu2004:base-cuda11.3-cudnn8
